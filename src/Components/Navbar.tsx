...
import navbarStyles from "../styles/css/Navbar.module.css";
import Image from "next/image";

import navbar_acc from "../img/navbar_account.png";
...
const Navbar = () => {
  return (
    <div className={`${navbarStyles.navbar}`}>
      <div className={`${navbarStyles.navbar_div}`}>
        <div className={`${navbarStyles.nav_left_div}`}>
          <div className={`${navbarStyles.nav_icon_div}`}>
            <div className={`${navbarStyles.nav_icon_big}`}></div>
            <div className={`${navbarStyles.nav_icon_small}`}></div>
          </div>

          <div className={`${navbarStyles.nav_icon_arrow_div}`}>
            <svg
              className={`${navbarStyles.nav_icon_arrow}`}
              width="7"
              height="12"
              viewBox="0 0 7 12"
              fill="none"
        ...
        <div className={`${navbarStyles.nav_right_div}`}>
          <div className={`${navbarStyles.nav_icon_search_div}`}>
            <svg
              className={`${navbarStyles.nav_icon_search}`}
              width="23"
              height="23"
              viewBox="0 0 23 23"
              fill="none"
          ...
          <div className={`${navbarStyles.nav_icon_mail_div}`}>
            <svg
              className={`${navbarStyles.nav_icon_mail}`}
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <div className={`${navbarStyles.nav_icon_bell_div}`}>
            <svg
              className={`${navbarStyles.nav_icon_bell}`}
              width="22"
              height="24"
              viewBox="0 0 22 24"
              fill="none"
          ...
          <div className={`${navbarStyles.nav_icon_question_div}`}>
            <svg
              className={`${navbarStyles.nav_icon_question}`}
              width="26"
              height="26"
              viewBox="0 0 26 26"
              fill="none"
          ...
          <div className={`${navbarStyles.nav_icon_acc_img_div}`}>
            <Image
              className={`${navbarStyles.nav_icon_acc_img}`}
              src={navbar_acc}
              height={18}
              width={18}
              alt={"Account Image"}
